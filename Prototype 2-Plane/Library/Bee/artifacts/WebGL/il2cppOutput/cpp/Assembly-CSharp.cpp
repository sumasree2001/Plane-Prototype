...
{
	// System.Single SpinPropellerX::rotationSpeed
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerControllerX_FixedUpdate_mF6B5972ED4C7FA460F293640E0EF7A5DDE586A23 (PlayerControllerX_tF9D775557FE097FA08B4768B1295EA527AFF0D2B* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Transform_Rotate_m35B44707FE16FF8015D519D8C162C0B4A85D6D1F(L_7, L_8, ((float)il2cpp_codegen_multiply(((float)il2cpp_codegen_multiply(((float)il2cpp_codegen_multiply(L_9, L_10)), (-1.0f))), L_11)), NULL);
		// }
		return;
	}
}
...
{
	{
		...
		__this->___rotationSpeed_5 = (25.0f);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
